...
# Stage 2 thresholds
FAITHFULNESS_THRESHOLD = 0.5   # below this → trigger fallback
...
Please re-answer the question using ONLY information explicitly stated in the numbered passages below.
- If the answer is clearly present, state it and cite the passage number like [1], [2], etc.
