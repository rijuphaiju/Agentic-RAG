const STAGES = [
  {
    ...
    label: 'Stage 1',
    sub:   'Basic RAG',
    desc:  'Query embedding → FAISS retrieval → LLM generation. No verification. Establishes hallucination baseline.',
    icon:  '◈',
  },
  {
    id:    'stage2',
    label: 'Stage 2',
    sub:   'RAG + Verifier',
    desc:  'Adds DistilBERT faithfulness verifier. Classifies answers as SUPPORTED, PARTIAL, or UNSUPPORTED.',
    icon:  '◉',
  },
  {
    id:    'stage3',
    ...
    desc:  'Classifies query complexity (SIMPLE / MULTI_HOP / COMPARISON) and applies the best retrieval strategy.',
    icon:  '◆',
  },
  {
    id:    'stage4',
    label: 'Stage 4',
    sub:   'Agentic Decision Loop',
    desc:  'Iterative retrieve → generate → verify loop. Reformulates on PARTIAL/UNSUPPORTED. Abstains if unresolvable.',
    icon:  '✦',
  },
]
